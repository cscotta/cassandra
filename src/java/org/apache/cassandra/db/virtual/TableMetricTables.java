...
public class TableMetricTables
{
    ...
    public static Collection<VirtualTable> getAll(String name)
    {
        return ImmutableList.of(
            ...
            new HistogramTableMetric(name, "read_iops_per_read", t -> t.readIopsPerRead.cf),
            new HistogramTableMetric(name, "bytes_read_per_read", t -> t.bytesReadPerRead.cf),
            new HistogramTableMetric(name, "files_touched_per_read", t -> t.filesTouchedPerRead.cf),
            new HistogramTableMetric(name, "bytes_decompressed_per_read", t -> t.bytesDecompressedPerRead.cf),
            new HistogramTableMetric(name, "chunk_cache_hits_per_read", t -> t.chunkCacheHitsPerRead.cf),
            new HistogramTableMetric(name, "chunk_cache_misses_per_read", t -> t.chunkCacheMissesPerRead.cf),
